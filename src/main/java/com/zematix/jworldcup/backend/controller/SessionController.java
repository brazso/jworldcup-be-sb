...
//	private AmqpAdmin amqpAdmin;
	 ...
	 * 
	 * @param sessionDataDto - session data comes from client
...
//		notifySessionData(sessionDataMapper.entityToDto(sessionData)); // test
	 ...
	 * Same as {@link refreshSessionData} method but this returns the result via websocket.
	 * 
...
//		boolean isDone = amqpAdmin.deleteQueue(destination);
